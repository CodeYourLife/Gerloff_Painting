...
path("toolbox_file/<int:scheduled_id>/<str:language>/",
     views.toolbox_file,
     name="toolbox_file"),
path('toolbox-talk/assign/', views.toolbox_talk_assign, name='toolbox_talk_assign'),
path('ajax/subcontractor-employees/', views.ajax_subcontractor_employees, name='ajax_subcontractor_employees'),
path('ajax/subcontractor-jobs/', views.ajax_subcontractor_jobs, name='ajax_subcontractor_jobs'),
path('employees/participation_ajax', views.participation_ajax, name='participation_ajax'),
path('upload_toolbox_file/', views.upload_toolbox_file, name='upload_toolbox_file'),
path('get_scheduled_toolbox_folder/', views.get_scheduled_toolbox_folder, name='get_scheduled_toolbox_folder'),
