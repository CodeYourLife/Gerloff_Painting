...
urlpatterns = [
    ...
    path('job_page/<jobnumber>/emails/detail', views.job_email_detail, name='job_email_detail'),
    path('job_page/<jobnumber>/emails/attachment', views.job_email_attachment, name='job_email_attachment'),
