...
class ChangeOrderTable(tables.Table):
    edit = tables.TemplateColumn('<a href="{% url "extra_work_ticket" record.id %}">{{record.cop_number}}</a>', verbose_name="COP Number")
    class Meta:
        model = ChangeOrders
        template_name = "django_tables2/bootstrap.html"
        fields = ("job_number","edit","description","need_ticket","date_sent","date_approved","gc_number","price")
